...
#define STYLE_FUNCTION(function) (MURRINE_ENGINE_GET_CLASS (style)->style_functions[params.style].function)

#define PRINT_DETAIL(section,detail,widget) printf("%s: %s %s\n", section, detail, G_OBJECT_TYPE_NAME (widget));

G_DEFINE_DYNAMIC_TYPE (MurrineEngine, murrine_engine, GTK_TYPE_THEMING_ENGINE)
...
void
murrine_engine_register_types (GTypeModule *module)
{
	murrine_engine_register_type (module);
}
...
static void
murrine_engine_class_init (MurrineEngineClass *klass)
{
...
static void
murrine_engine_class_finalize (MurrineEngineClass *klass)
{
}
